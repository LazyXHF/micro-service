...
public class ProjectDeclaration {
    ...
    public void setTechnosphere(String technosphere) {
        this.technosphere = technosphere == null ? null : technosphere.trim();
    }
    ...
    public String getEscheatage() {
        return escheatage;
    }

    public void setEscheatage(String escheatage) {
        this.escheatage = escheatage == null ? null : escheatage.trim();
    }
