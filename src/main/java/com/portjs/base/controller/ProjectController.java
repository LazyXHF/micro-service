...
public class ProjectController extends BaseController {
    ...
    @LogInfo(methodName = "项目概览新建项目", modelName = "项目概览")
    @RequestMapping("insert-project")
    @ResponseBody
    public ResponseMessage insertProject(@RequestBody String requestBody) {
        JSONObject requestJson = JSONObject.parseObject(requestBody);
        return projectService.insertProject(requestJson);
    }
